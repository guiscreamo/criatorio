        	...
        	<div class="row">
        		<div class="col-sm-12">
        			<form action="" method="GET" class="adicionar">
        				...
        				<span>DATA COMPRA: </span><br><input type="date" name="data_compra" required><br>
...
<?php
	if(isset($_GET['adicionar'])){
		$id = filter_input(INPUT_GET, "id");
		$dt_compra = $_GET['data_compra'];
		$quantidade_anterior = $_GET['qtde'];
		$quantidade = $_GET['quantidade'];

		$res = $quantidade_anterior + $quantidade;

		$altera = $mysqli->query("UPDATE estoque_suprimento SET qtde = '$res', dt_compra = '$dt_compra' WHERE id = '$id'");
