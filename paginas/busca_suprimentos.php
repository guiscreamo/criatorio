<?php
  ...
  $sql = $mysqli->query("SELECT * FROM estoque_suprimento WHERE tipo LIKE '%$pesquisa%' OR nome LIKE '%$pesquisa%' OR dt_compra LIKE '%$pesquisa%' OR mes LIKE '%$pesquisa%'");
}
$mysqli->error;
              ...
              <table class="table table-bordered">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td><a href="<?php echo "../funcoes/adicionar.php?id=" . $row['id'] . "&tipo=" . $row['tipo'] . "&nome=" . $row['nome'] . "&dt_compra=" . $row['dt_compra'] . "&mes=" . $row['mes'] . "&valor=" . $row['valor'] . "&qtde=" . $row['qtde'] ?>" class="glyphicon glyphicon-plus" title="Adiconar"></a></td>
                          <td><a href="<?php echo "../funcoes/retirar.php?id=" . $row['id'] . "&tipo=" . $row['tipo'] . "&nome=" . $row['nome'] . "&dt_compra=" . $row['dt_compra'] . "&mes=" . $row['mes'] . "&valor=" . $row['valor'] . "&qtde=" . $row['qtde'] ?>" class="glyphicon glyphicon-minus" title="Retirar"></a></td>
                      </tr>
