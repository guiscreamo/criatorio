<?php
  ...
  $sql = $mysqli->query("SELECT * FROM passaros WHERE ci LIKE '%$pesquisa%' OR gefau LIKE '%$pesquisa%' OR dt_nascto LIKE '%$pesquisa%' OR especie LIKE '%$pesquisa%' OR nome_cientifico LIKE '%$pesquisa%' OR sexo LIKE '%$pesquisa%' OR coloracao LIKE '%$pesquisa%'  ");
}
$mysqli->error;
