    ...
    <!-- INICIO MENU LATERAL -->
        ...
        <div class="container-fluid">
          ...
          <div class="page-header">
            <h2>Visualização Usuários</h2>
          </div>
          <?php include "../funcoes/visualizacao_usuarios.php"; ?>
              ...
              <table class="table table-bordered">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td><a href="<?php echo "trocar_senha.php?id=" . $row['id'] . "&nome=" . $row['nome'] . "&telefone=" . $row['telefone'] . "&email=" . $row['email'] . "&login=" . $row['login'] . "&senha=" . $row['senha'] ?>" class="glyphicon glyphicon-pencil" title="Trocar Senha" style="color: black; text-decoration: none;"></a></td>
                      </tr>
